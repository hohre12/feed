...
- **족보/큐레이션 리스트** — 저장+공유+댓글 3박자. 팔로우 전환율 최고

## 팔로우 터지는 3박자 공식

단순 좋아요가 아니라 **팔로워 증가**를 만드는 조건:

1. **압도적 정보성** — 구체적 이름/숫자가 있는 정보. "좋은 제품 추천"이 아니라 "유니클로 수피마 코튼T" 수준
2. **저장/공유 자극** — 지금 당장 안 써도 "나중에 필요할 때 보려고" 저장하게 만드는 글
3. **댓글 참여 유도** — "더 있으면 알려줘", "너는 뭐 써?" 같은 열린 질문

이 3개가 동시에 맞으면 팔로우가 폭발함. 한 글로 수천 팔로워 가능.

> "대충 쓰는 게 구어체에 제일 가까워서. 다듬을수록 문어체 느낌남."
> — 스레드에서 실제 검증된 인사이트. 툭툭 쓸수록 조회수/팔로우 증가
