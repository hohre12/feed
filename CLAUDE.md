...
## Architecture
- **Plugin (this repo)**: read-only templates -- skills, rules, platforms, styles, audiences, flows
...
- `audiences/` -- Target audience profiles (tone, terminology, search sources)
...
- Per audience: `audiences/{audience}.md`
